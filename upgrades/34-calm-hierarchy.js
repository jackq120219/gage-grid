...
(()=>{
  ...
  function organize(){
    ...
    if(drawer)drawer.open=document.body.classList.contains('gg-density-full');
    moving=false;
  }
  function installToggle(){
    ...
    const apply=mode=>{const full=mode==='full';document.body.classList.toggle('gg-density-full',full);document.body.classList.toggle('gg-density-calm',!full);button.textContent=full?'ESSENTIAL VIEW':'FULL DETAIL';const drawer=ensureDrawer();if(drawer)drawer.open=full;try{localStorage.setItem(KEY,mode)}catch(_e){}};
  ...
  G.injectStyle('gg-calm-hierarchy-style',`
    ...
    .gg-density-calm .gg-os-deck{margin-top:38px!important}.gg-density-calm .gg-os-deck-head>div b{font-size:8px!important;font-weight:600!important}.gg-density-calm .gg-os-deck-head nav{gap:4px!important}.gg-density-calm .gg-os-deck-head button{padding:8px 10px!important}.gg-density-calm .gg-os-switchboard{position:relative!important;top:auto!important}.gg-density-calm .gg-os-switch-cells>div:nth-child(4){display:none!important}.gg-density-calm .gg-os-switch-cells{grid-template-columns:repeat(4,1fr)!important}
    .gg-density-full .gg-calm-deep>summary{background:#eef2f4}.gg-density-full .mini-metrics{max-height:none}.gg-density-full .gg-os-switch-cells>div:nth-child(4){display:grid!important}.gg-density-full .gg-os-switch-cells{grid-template-columns:repeat(5,1fr)!important}
